class script(object):
  ...
  Iᴛ's Sample ʜᴇʀᴇ ᴛʜᴇ ʙᴇꜱᴛ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ ʟᴀᴛᴇꜱᴛ ꜰᴇᴀᴛᴜʀᴇꜱ. </spoiler>
...
‼️ ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴄʜᴇᴄᴋ ᴀʟʟ ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʟᴀɴs & ɪᴛ's ᴘʀɪᴄᴇs</b>"""
    ...
    BUY_PLAN = """<b>➥ <u>ғɪʀsᴛ sᴛᴇᴘ</u> : ᴘᴀʏ ᴛʜᴇ ᴀᴍᴏᴜɴᴛ ᴀᴄᴄᴏʀᴅɪɴɢ ᴛᴏ ʏᴏᴜʀ ғᴀᴠᴏʀɪᴛᴇ ᴘʟᴀɴ ᴛᴏ ᴛʜɪs <code>narutopremium@axl</code> ᴜᴘɪ ɪᴅ.
...
➥ /set_tutorial https://t.me/</blockquote>
...
@MG_networKs Rᴇǫᴜᴇꜱᴛ Hᴇʀᴇ Aɴᴅ Uꜱᴇ Tʜɪꜱ Pᴀᴛᴛᴇʀɴ👇👇
...
<b> 🛍️ UPI ID - </b>  <code> Narutoprmium@axl </code>
